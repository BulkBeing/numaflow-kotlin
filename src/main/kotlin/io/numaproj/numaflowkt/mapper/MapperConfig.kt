...
/**
 * Configuration for the mapper gRPC server.
 *
 ...
 * at [socketPath].
 *
 * @property socketPath     Unix domain socket path. Default: `/var/run/numaflow/map.sock`.
...
data class MapperConfig(
    ...
    companion object {
        ...
        const val DEFAULT_SOCKET_PATH: String = "/var/run/numaflow/map.sock"
